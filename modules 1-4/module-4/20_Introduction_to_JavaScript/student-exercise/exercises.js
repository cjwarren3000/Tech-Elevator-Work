...
function lastDigit(n1, n2){
	...
	let n1LastDigit = n1String.substring(n1String.length-1);
	let n2LastDigit = n2String.substring(n2String.length-1);

	if(n2LastDigit === n1LastDigit){
		sameDigit = true;
	}
	return sameDigit;
}
...
function seeColor(color1){
	let result = "";
	
	if(color1.substring(0, 3) === "red"){
		result = "red";
	}
	else if(color1.substring(0,4) === "blue"){
		result = "blue";
	}
...
function frontAgain(givenString){
	...
	if(givenString.substring(0,2) === givenString.substring(givenString.length-2)){
		result = true;
	}
