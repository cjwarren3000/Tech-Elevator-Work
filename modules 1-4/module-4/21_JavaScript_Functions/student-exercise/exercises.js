 ...
 */
 ...
 function makeNumber(first, second = ""){
    ...
    concatNumber = Number(concatString);
     return concatNumber;
 }
...
function makeHappy(someArray){

    function addHappy(string){
    let newString = "Happy " + string;
    return newString;
    }

    newArray = someArray.map(addHappy);
...
function getFullAddressesOfProperties(arrayOfObjects){
    ...
    let streetAddress = function (element) {
        let addressString = "";

        addressString += element.streetNumber + " " + element.streetName + " " + element.streetType + " " + element.city + " " + element.state + " " + element.zip;
       
        return addressString;
    }

    stringArray = arrayOfObjects.map(streetAddress);
