...
namespace TenmoServer.DAO
{
    public class UserSqlDAO : IUserDAO
    {
        ...
        const string sql_getUserById = "SELECT user_id, username, password_hash, salt FROM users WHERE user_id = @user_id";
        const string sql_getUserByName = "SELECT user_id, username, password_hash, salt FROM users WHERE username = @username";
        ...
        public User GetUser(string username)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand(sql_getUserByName, conn);
